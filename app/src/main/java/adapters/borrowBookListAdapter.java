...
public class borrowBookListAdapter extends BaseAdapter{
    ...
    private List<borrowBookListBean> mDatas;
    ViewHolder holder = null;
    borrowBookListBean bean ;

    public borrowBookListAdapter(Context context, List<borrowBookListBean> datas) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = mInflater.inflate(R.layout.borrow_book_list, viewGroup, false); //加载布局
        ...
        holder.borrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                daoqi.setVisibility(View.VISIBLE);
                overTime.setText("2018-5-30");
        ...
        if(bean.getBorrowStatus()){
            borrow.setVisibility(View.INVISIBLE);
            borrowed.setVisibility(View.VISIBLE);
            daoqi.setVisibility(View.VISIBLE);
            overTime.setText(bean.getTimeOver());
            overTime.setVisibility(View.VISIBLE);
        }
        return view;
    }
