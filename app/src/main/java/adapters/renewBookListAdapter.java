...
public class renewBookListAdapter extends BaseAdapter{
    private LayoutInflater mInflater;
    private List<renewBookListBean> mDatas;
    ViewHolder holder = null;
    renewBookListBean bean ;

    public renewBookListAdapter(Context context, List<renewBookListBean> datas) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = mInflater.inflate(R.layout.renew_book_list, viewGroup, false); //加载布局
