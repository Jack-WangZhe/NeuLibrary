...
public class selfDynamicListBean {
    ...
    public selfDynamicListBean(String userPhotoURL, String userName, String userSendTime, String imageInfoURL, String itemDesc, String praiseNum, String commentNum) {
