...
//    }
    ...
    public void firstRequest(){
                ...
                try {
                    ...
                    if(back.getBoolean("status")){
                        ...
                        for(int i=0;i<info.length();i++){
                            ...
                            bean = new fansListBean(user_info.getString("userId"),user_info.getString("userName"),user_info.getString("userPhotoURL"));
                            mDatas.add(bean);
                        }
                        //为数据绑定适配器
                        fansListAdapter = new fansListAdapter(FansActivity.this, mDatas);
                        fansList.setAdapter(fansListAdapter);
                    }else {
                        String info = back.getString("info");
                        Toast.makeText(FansActivity.this,info,Toast.LENGTH_SHORT).show();
                    }
        ...
        getUserAttentions.getInfo(FansActivity.this, Urls.getUserFans+"?userId="+userId);
    }
